...
export default function ListaCadastro() {
  ...
  async function excluirProblema(cadastro) {
    ...
    Toast.show({
      type: 'success',
      text1: 'Vendedor excluído com sucesso!',
    });
  }
  ...
  async function editarProblema(cadastroAntigo, cadastroNovo) {
    ...
    Toast.show({
      type: 'success',
      text1: 'Vendedor editado com sucesso!',
    });
    navigation.goBack();
  }
  ...
  return (
    ...
    <View style={styles.container}>
          ...
          <Card mode="outlined" style={styles.card}>
            <Card.Content style={styles.cardContent}>
              <View style={{ flex: 1 }}>
                ...
                <Text variant="bodyLarge">N° de Cadastro: {item?.cadastro}</Text>
              </View>
            </Card.Content>
            <Card.Actions>
              <Button
                onPress={() =>
                  navigation.push('FormCad', {
      ...
      <FAB
        icon="plus"
        style={styles.fab}
        onPress={() => navigation.push('FormCad', { acao: adicionarCadastro })}
      />
    </View>
